    ...
    <div>
        <header>
            <nav class="flex w-75 justify-around f4 code pa1">
                ...
                <nuxt-link class="link underline-hover" to="/inputUser">User</nuxt-link>
                <nuxt-link class="link underline-hover" to="/parent">Communicate</nuxt-link>
                <nuxt-link class="link underline-hover" to="/handleInput">Handle</nuxt-link>
            </nav>
        </header>
        <nuxt></nuxt>
    </div>
